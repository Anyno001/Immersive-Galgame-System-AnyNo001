...
const { readLegacyIgsSettings, writeLegacyIgsSettings, resolveLegacyReaderMode } = require("src/storage/legacy-igs.js");
...
const { createSceneState } = require("src/scene/scene-state.js");const { matchBackgroundRule } = require("src/scene/background-rules.js");const { matchCharacterRule } = require("src/scene/character-rules.js");
...
const { esc } = require("src/visual/igs-ui/reader-value-utils.js");const { TOOLBAR_ACTIONS } = require("src/visual/igs-ui/reader-host-constants.js");
...
const { DEFAULT_VIRTUAL_REGEX } = require("src/scene/message-source.js");const { cloneData } = require("src/visual/igs-ui/reader-value-utils.js");const { DEFAULT_SCENE_PROMPT_RULE, TOOLBAR_ACTIONS } = require("src/visual/igs-ui/reader-host-constants.js");const { DEFAULT_MOOD_GROUPS, normalizeMoodGroups } = require("src/scene/mood-groups.js");const { loadScenePresets, saveScenePresets } = require("src/scene/scene-preset-store.js");
...
const { chamiProvider } = require("src/generated-images/providers/chami-provider.js");const { domGenericProvider } = require("src/generated-images/providers/dom-generic-provider.js");const { naiProvider } = require("src/generated-images/providers/nai-provider.js");const { stChatu8Provider } = require("src/generated-images/providers/st-chatu8-provider.js");
