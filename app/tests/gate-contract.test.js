...
test('gate:igs-ui:reader-source-keeps-original-selectors', () => {
    ...
    assert.match(source.styleText, /#igs-status-hud \.igs-hud-toggle\{[^}]*width:calc\(36px \* var\(--igs-hud-scale,1\)\);height:calc\(36px \* var\(--igs-hud-scale,1\)\)[^}]*border:0;background:transparent;border-radius:0/);
    assert.match(source.styleText, /#igs-status-hud \.igs-hud-toggle svg\{width:calc\(18px \* var\(--igs-hud-scale,1\)\);height:calc\(18px \* var\(--igs-hud-scale,1\)\);\}/);
