...
#igs-status-hud .igs-hud-entry-menu{position:absolute;left:100%;top:calc(50% + 2.5px);transform:translateY(-50%);z-index:3;display:flex;flex-direction:row;align-items:center;gap:4px;padding-left:20px;pointer-events:none;}
