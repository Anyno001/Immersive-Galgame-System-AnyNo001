...
#igs-status-hud .igs-hud-entry-arrow{position:absolute;left:calc(100% + 2px);top:50%;transform:translateY(-50%);display:grid;place-items:center;width:32px;height:32px;padding:0;border:0;background:transparent;color:rgba(232,230,226,.7);cursor:pointer;pointer-events:auto;}
#igs-status-hud .igs-hud-entry-arrow svg{width:13px;height:13px;}
...
#igs-status-hud .igs-hud-entry-menu{position:absolute;left:100%;top:50%;transform:translateY(-50%);z-index:3;display:flex;flex-direction:row;align-items:center;gap:2px;padding-left:36px;pointer-events:none;}
#igs-status-hud .igs-hud-entry-menu[hidden]{display:none;}
#igs-status-hud .igs-hud-entry-item{display:flex;align-items:center;gap:3px;min-width:0;padding:3px 4px;border:0;background:transparent;color:rgba(232,230,226,.78);font-size:11px;white-space:nowrap;cursor:pointer;pointer-events:auto;}
#igs-status-hud .igs-hud-entry-item:hover{color:#fff;}
#igs-status-hud .igs-hud-entry-item svg{width:13px;height:13px;flex:none;}
...
@media (pointer:coarse){#igs-status-hud .igs-hud-entry-arrow{width:44px;height:44px;}#igs-status-hud .igs-hud-entry-menu{padding-left:48px;}#igs-status-hud .igs-hud-location[data-act="map"]{min-height:44px;}}
