...
#igs-status-hud .igs-hud-entry-arrow{position:absolute;left:calc(100% - 4px);top:calc(50% + 1.5px);transform:translateY(-50%);display:grid;place-items:center;width:32px;height:32px;padding:0;border:0;background:transparent;color:rgba(232,230,226,.7);cursor:pointer;pointer-events:auto;}
...
#igs-status-hud .igs-hud-entry-menu{position:absolute;left:100%;top:calc(50% + 1.5px);transform:translateY(-50%);z-index:3;display:flex;flex-direction:row;align-items:center;gap:4px;padding-left:30px;pointer-events:none;}
